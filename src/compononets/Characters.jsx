...
const Characters = () => {
    ...
    return ( 
        ...
        <AnimatePresence>
            ...
            <motion.div initial={{opacity: 0}} animate={{opacity: 1}} transition={{delay: 0.7}} className=" grid justify-center absolute z-[10] top-0 left-0 right-0 mx-auto pt-[20px] px-[20px]" 
